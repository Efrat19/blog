...
Good job! you are ready to move to the next part - [adding EKS scheduling](https://efrat19.github.io/kubephoric/aws-managed-airflow-eks-scheduling-part-2-scheduling-dags-on-eks)
